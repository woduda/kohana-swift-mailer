...
class Kohana_Email {
	 ...
	 * @param string $attachment_filename - filename to attach as
	 * @return Email
	 */
	public function add_attachment_file($file_path, $mime, $attachment_filename = NULL)
	{
		$attachment = Swift_Attachment::fromPath($file_path, $mime);
